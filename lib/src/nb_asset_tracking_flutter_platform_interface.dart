...
abstract class NbAssetTrackingFlutterPlatform extends PlatformInterface {
  ...
  static NbAssetTrackingFlutterPlatform _instance =
  ...
  Future<void> setAndroidNotificationConfig(
      {required AndroidNotificationConfig config}) {
    throw UnimplementedError(
        'setAndroidNotificationConfig() has not been implemented.');
  }

  Future<String> getAndroidNotificationConfig() {
    throw UnimplementedError(
        'getAndroidNotificationConfig() has not been implemented.');
  }

  Future<void> setIOSNotificationConfig(
      {required IOSNotificationConfig config}) {
    throw UnimplementedError(
        'setIOSNotificationConfig() has not been implemented.');
  }

  Future<String> getIOSNotificationConfig() {
    throw UnimplementedError(
        'getIOSNotificationConfig() has not been implemented.');
  }

  Future<void> updateLocationConfig({required LocationConfig config}) {
    throw UnimplementedError(
        'updateLocationConfig() has not been implemented.');
  }
  ...
  Future<void> setDataTrackingConfig({required DataTrackingConfig config}) {
    throw UnimplementedError(
        'setDataTrackingConfig() has not been implemented.');
  }

  Future<String> getDataTrackingConfig() {
    throw UnimplementedError(
        'getDataTrackingConfig() has not been implemented.');
  }
