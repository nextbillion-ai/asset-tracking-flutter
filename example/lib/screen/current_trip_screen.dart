            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  if (tripInfo.metaData != null || tripInfo.attributes != null)
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            if (tripInfo.metaData != null && tripInfo.metaData!.isNotEmpty) ...[
              const Text(
                'Meta Data:',
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    _buildInfoRow('Geofence ID', stop.geofenceId, indent: true),
