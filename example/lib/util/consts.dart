...
var baseUrlProd =
    Platform.isAndroid ? "https://api.nextbillion.io" : "api.nextbillion.io";
var baseUrlStaging = Platform.isAndroid
    ? "https://sgpstg.nextbillion.io"
    : "sgpstg.nextbillion.io";

enum EnvConfig {
  prod,
  staging;

  static EnvConfig fromString(String s) =>
      switch (s) { "prod" => prod, "staging" => staging, _ => prod };
}
